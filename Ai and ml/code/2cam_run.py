...
while True:
    ...
    for encodeFace,faceLoc in zip(encodesCurFrame,facesCurFrame,encodesCurFrame1,facesCurFrame1):
    ...
    #  elif faceDis1[matchIndex1]<0.50:
    #      name=classNames[matchIndex].upper()
    #      #print(name)
    #      y1,x2,y2,x1=faceLoc
    #      y1,x2,y2,x1 = y1*4,x2*4,y2*4,x1*4
    ...
    #  
    cv2.imshow('cctv ',img)
    cv2.imshow('2nd and camera',img1)
    cv2.waitKey(1) 
    #writer.save()
